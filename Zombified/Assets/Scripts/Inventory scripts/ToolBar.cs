...
public class ToolBar : MonoBehaviour
{
    ...
    public static void menuItemCreateInventory()       //create the inventory at start
    {
        ...
        if (GameObject.FindGameObjectWithTag("Canvas") == null)
        {
            ...
            Layout = (GameObject)Instantiate(Resources.Load("Prefabs/Canvas - Inventory") as GameObject);
            Layout.transform.SetParent(inventory.transform, true);
            GameObject panel = (GameObject)Instantiate(Resources.Load("Prefabs/Panel - Hotbar") as GameObject);
            panel.GetComponent<RectTransform>().localPosition = new Vector3(0, 0, 0);
            panel.transform.SetParent(Layout.transform, true);
            GameObject draggingItem = (GameObject)Instantiate(Resources.Load("Prefabs/DraggingItem") as GameObject);
            Instantiate(Resources.Load("Prefabs/EventSystem") as GameObject);
            draggingItem.transform.SetParent(Layout.transform, true);
        ...
        else
        {
           ...
           // Inventory inv = panel.AddComponent<Inventory>();
            ...
            GameObject draggableItem = (GameObject)Instantiate(Resources.Load("Prefabs/DraggingItem") as GameObject);
            draggableItem.transform.SetParent(GameObject.FindGameObjectWithTag("Canvas").transform, true);
            panel.AddComponent<InventoryDesign>();
           // inv.getPrefabs();
        }
    }
